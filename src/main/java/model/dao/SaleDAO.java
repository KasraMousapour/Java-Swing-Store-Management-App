...
public class SaleDAO {
    ...
    public boolean createSale(Sale sale) throws SQLException {
        ...
        statement.setInt(5, sale.getNumber());
    ...
    public String[][] readSalesTableData() throws SQLException {
