...
public class UserDAO {
    ...
    public boolean createUser(User user) throws SQLException {
        ...
        statement.setFloat(7, user.getInventory());
    ...
    public boolean updateUser2(User user) throws SQLException {
        query = "UPDATE User SET full_name = ?, password = ?, email = ?, access_level = ?, address = ?, inventory = ?, phone_number = ? WHERE username = ?";
        statement = connection.prepareStatement(query);
        statement.setString(1, user.getFullName());
        statement.setString(2, user.getPassword());
        statement.setString(3, user.getEmail());
        ...
        statement.setFloat(6, user.getInventory());
    ...
    public boolean updateUserInventory(User user) throws SQLException{
        query = "UPDATE User SET inventory = ? WHERE username = ?";
        statement = connection.prepareStatement(query);
        statement.setFloat(1, user.getInventory());
        statement.setString(2, user.getUsername());
        insertedLines = statement.executeUpdate();
        return(insertedLines != 0);
    }
